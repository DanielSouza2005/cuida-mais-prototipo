...
public class CaregiverServiceRequestService {
  ...
  private CaregiverReceivedRequestResponse response(ServiceRequest entity, boolean conflict) {
    ...
    return new CaregiverReceivedRequestResponse(entity.getId(), entity.getStatus(), entity.getCreatedAt(), entity.getExpiresAt(), conflict,
      new CaregiverReceivedRequestResponse.Responsible(entity.getResponsibleUser().getId(), entity.getResponsibleUser().getFullName(), profile == null ? null : String.valueOf(profile.getParentescoOutro() != null ? profile.getParentescoOutro() : profile.getParentesco()), profile == null || profile.getPreferenciaContato() == null ? null : profile.getPreferenciaContato().name()),
