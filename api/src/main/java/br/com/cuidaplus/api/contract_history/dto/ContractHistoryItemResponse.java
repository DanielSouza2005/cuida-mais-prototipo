...
public record ContractHistoryItemResponse(
  ...
  String participantName, String participantPhotoUrl, ContractParticipantRole participantRole, String assistedPersonName,
  ...
  String rejectionReason, String terminationReason, String cancellationReason, String closureReason,
  ContractTerminationType terminationType, LocalDate effectiveEndDate, Instant terminationRequestedAt,
