...
public interface CareActivityRecordRepository extends JpaRepository<CareActivityRecord, UUID> {
  ...
  List<CareActivityRecord> findByContractAndEntryDateAndSourceTypeOrderByOccurredAtAsc(CareContract contract, LocalDate date, CareRecordSourceType sourceType);
