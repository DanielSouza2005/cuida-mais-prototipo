...
public final class NotificationCatalog {
  ...
  private static Map<NotificationType, NotificationDefinition> definitions() {
    ...
    add(values, NotificationType.SERVICE_OPPORTUNITY_APPLICATION_CREATED, "Novos interessados em serviços", "Avise quando um cuidador demonstrar interesse em um serviço publicado.", NotificationAudience.RESPONSAVEL, NotificationCategory.SERVICOS_PUBLICADOS, "user-plus", "blue", RelatedEntityType.SERVICE_REQUEST);
    add(values, NotificationType.SERVICE_OPPORTUNITY_APPLICATION_ACCEPTED, "Interesse aceito e contratação criada", "Avise quando o responsável aceitar seu interesse e criar a contratação.", NotificationAudience.CUIDADOR, NotificationCategory.INTERESSES, "circle-check", "green", RelatedEntityType.CARE_CONTRACT);
    add(values, NotificationType.SERVICE_OPPORTUNITY_APPLICATION_REJECTED, "Interesse rejeitado", "Avise quando o responsável rejeitar seu interesse em um serviço.", NotificationAudience.CUIDADOR, NotificationCategory.INTERESSES, "circle-x", "red", RelatedEntityType.SERVICE_REQUEST);
    add(values, NotificationType.SERVICE_PUBLICATION_CREATED, "Serviço publicado", "Avise quando uma nova oportunidade de serviço for publicada.", NotificationAudience.RESPONSAVEL, NotificationCategory.SERVICOS_PUBLICADOS, "clipboard-plus", "green", RelatedEntityType.SERVICE_REQUEST);
    add(values, NotificationType.SERVICE_PUBLICATION_CANCELED, "Serviço publicado cancelado", "Avise quando uma publicação de serviço for cancelada.", NotificationAudience.RESPONSAVEL, NotificationCategory.SERVICOS_PUBLICADOS, "ban", "slate", RelatedEntityType.SERVICE_REQUEST);
    add(values, NotificationType.SERVICE_PUBLICATION_EXPIRED, "Serviço publicado expirado", "Avise quando o prazo de uma publicação de serviço terminar.", NotificationAudience.RESPONSAVEL, NotificationCategory.SERVICOS_PUBLICADOS, "clock-alert", "orange", RelatedEntityType.SERVICE_REQUEST);
    add(values, NotificationType.SERVICE_PUBLICATION_STATUS_UPDATED, "Atualizações de serviços publicados", "Avise sobre mudanças de situação nos serviços publicados.", NotificationAudience.RESPONSAVEL, NotificationCategory.SERVICOS_PUBLICADOS, "info", "indigo", RelatedEntityType.SERVICE_REQUEST);
    ...
    add(values, NotificationType.SERVICE_ATTENDANCE_STARTED, "Atendimento iniciado", "Avisar quando o cuidador iniciar um atendimento.", NotificationAudience.RESPONSAVEL, NotificationCategory.CONTRATACOES, "play-circle", "green", RelatedEntityType.CARE_CONTRACT);
    add(values, NotificationType.SERVICE_ATTENDANCE_ENDED, "Atendimento encerrado", "Avisar quando o cuidador encerrar um atendimento.", NotificationAudience.RESPONSAVEL, NotificationCategory.CONTRATACOES, "circle-stop", "purple", RelatedEntityType.CARE_CONTRACT);
    add(values, NotificationType.ATTENDANCE_REPORT_AVAILABLE, "Relatório de atendimento disponível", "Avisar quando o cuidador finalizar um relatório de atendimento.", NotificationAudience.RESPONSAVEL, NotificationCategory.CONTRATACOES, "file-check", "blue", RelatedEntityType.ATTENDANCE_REPORT);
