...
Este documento registra a primeira etapa de tradução, entre as migrations V031–V038. A organização relacional final da V039, inclusive para tabelas que mantiveram o nome, está em [dicionario-nomenclatura-relacional.md](dicionario-nomenclatura-relacional.md). Os identificadores físicos usam `snake_case`, sem acentos. Nomes Java, propriedades JSON e endpoints REST foram preservados.
