...
const visuals: Record<string, NotificationVisual> = {
  ...
  SERVICE_ATTENDANCE_STARTED: visual(PlayCircle, '#25875A', '#E5F5EC', 'Atendimento iniciado', 'Contratações'),
  SERVICE_ATTENDANCE_ENDED: visual(CircleStop, '#7254A3', '#F0EBF8', 'Atendimento encerrado', 'Contratações'),
  ATTENDANCE_REPORT_AVAILABLE: visual(FileCheck2, '#2477B3', '#E7F2FA', 'Relatório disponível', 'Contratações'),
