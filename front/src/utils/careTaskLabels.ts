...
export const taskRecurrenceLabels: Record<TaskRecurrenceType, string> = { UNICA: 'Cuidado único', DIARIA: 'Diária', DIAS_ESPECIFICOS: 'Dias específicos', INTERVALO: 'Intervalo em dias', PERIODO_DETERMINADO: 'Período determinado', SEM_DATA_FINAL: 'Sem data final' };
