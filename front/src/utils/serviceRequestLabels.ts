...
export const statusLabels: Record<ServiceRequestStatus, string> = { PENDENTE: 'Pendente', ACEITA: 'Aceita', REJEITADA: 'Rejeitada', CANCELADA: 'Cancelada', EXPIRADA: 'Expirada' };
