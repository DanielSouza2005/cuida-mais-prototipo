...
export default function ProfilePrivacyScreen() {
  ...
  return (
    <ScreenContainer keyboardAvoiding contentStyle={styles.content}>
      <AppHeader showBack backDisabled={busy} title="Privacidade" subtitle="Segurança da conta e dados pessoais" />
      ...
      {step === 'information' ? (
        <View style={styles.card}>
          ...
          <View style={styles.list}>
            ...
            <Text style={styles.item}>• seus dados pessoais que não precisarem ser mantidos serão eliminados ou anonimizados;</Text>
            <Text style={styles.item}>• determinadas informações poderão ser mantidas pelo período necessário para obrigações legais, segurança ou exercício de direitos;</Text>
      ...
      {step === 'identity' ? (
        <View style={styles.card}>
          ...
          <PrimaryButton label="Cancelar" variant="secondary" disabled={busy} onPress={() => router.back()} />
        </View>
      ) : null}
