...
export default function AdminTabNavigator() {
  ...
  return <Tabs initialRouteName="index" screenOptions={{headerShown:false,tabBarActiveTintColor:colors.admin,tabBarInactiveTintColor:colors.mutedForeground,tabBarLabelStyle:styles.label,tabBarStyle:styles.tabBar,tabBarItemStyle:styles.item}}>
