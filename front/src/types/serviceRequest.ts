...
export type ServiceRequestFormData = { caregiver: ServiceRequestCaregiver; assistedPersons: ServiceRequestAssistedPerson[]; careAddresses: ServiceRequestAddress[]; activityOptions: RequestedActivity[]; weekdayOptions: string[]; hiringTypeOptions: HiringType[] };
...
export type ServiceRequestPayload = {
  caregiverId: string; assistedPersonId: string; careAddressId: string; hiringType: HiringType;
  startDate: string | null; endDate: string | null; specificDates: string[]; scheduleDays: RequestedScheduleDay[];
  needsDescription: string; activities: RequestedActivity[]; activityOther: string | null;
